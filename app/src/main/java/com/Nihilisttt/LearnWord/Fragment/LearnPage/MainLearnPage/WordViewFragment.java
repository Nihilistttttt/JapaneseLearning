...
public abstract class WordViewFragment<T> extends Fragment {
    private List<T> data;

    public WordViewFragment() {}

    public WordViewFragment(List<T> data) {
        this.data = data;
    }

    protected abstract View createContentView(Context context, LifecycleOwner lifecycleOwner, int layoutType, List<T> data);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        View contentView = createContentView(requireContext(), this, subFontLevel, data);
