...
public class SynonymWordView extends LinearLayout {

    private static final String TAB = "SynonymWordView";
    ...
    public SynonymWordView(Context context, @NonNull LifecycleOwner lifecycleOwner, int layoutType, List<SynonymWord> synonymWords) {
        ...
        initViews(context, synonymWords);
    }


    private void initViews(Context context, List<SynonymWord> synonymWords) {
        for (SynonymWord synonymWord : synonymWords) {
            ...
            List<String> kanjiComponents = synonymWord.getKanjiComponents();
            List<String> kanaComponents = synonymWord.getKanaComponents();
            ...
            WordComponentView wordComponentLayout = new WordComponentView(
                    ...
                    lifecycleOwner,
                    layoutParams,
                    synonymWord.getKanjiComponents(),
                    synonymWord.getKanaComponents(),
                    synonymWord.getCorrespondingWordId()
            );
            // 整体布局结构
