...
import com.Nihilisttt.LearnWord.Fragment.SearchPage.DictionaryFragment;

public class SearchPageAdapter extends FragmentStateAdapter {
    // 当前版本只包含学习页面
    private static final int PAGE_COUNT = 2;
    private static final float MIN_SCALE = 0.75f;
    private final String TAG = "SearchPageAdapter";

    public SearchPageAdapter(FragmentActivity fragmentActivity) {
