...
public class Vp2IndicatorView extends View {
    public static final int STYLE_CIRCLE_CIRCLE = 0;
    ...
    //指示器样式，默认都是圆点
    private int mIndicatorStyle = STYLE_CIRCLE_CIRCLE;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicatorItemCount; i++) {
            ...
            canvas.drawCircle(cx, cy, circleCircleRadius,
                    i == mCurrentSelectedPosition ? mSelectedPaint : mUnSelectedPaint);
        }
    }
    ...
    public void attachToViewPager2(ViewPager2 vp2) {
        ...
        if (pagerAdapter != null) {
            ...
            mCurrentSelectedPosition = vp2.getCurrentItem();
            verifyItemCount();
        }
